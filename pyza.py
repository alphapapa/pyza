...
def main():
    ...
    # **** Parse args
    parser = argparse.ArgumentParser(description="A terminal-based Songza client.  Plays with VLC by default, or with MPD.",
    ...
    parser.add_argument('-e', '--exclude',
                        ...
                        help="Exclude stations whose names or descriptions match strings")
